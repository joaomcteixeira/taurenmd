...
project = 'Tauren-MD'
copyright = '2019, João M.C. Teixeira'
...
htmlhelp_basename = 'Tauren-MDdoc'
...
latex_documents = [
    (master_doc, 'Tauren-MD.tex', 'Tauren-MD Documentation',
     'João M.C. Teixeira', 'manual'),
]
...
man_pages = [
    (master_doc, 'tauren-md', 'Tauren-MD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Tauren-MD', 'Tauren-MD Documentation',
     author, 'Tauren-MD', 'One line description of project.',
     'Miscellaneous'),
]
...
extlinks = {
    ...
    "mdaselections": ("https://www.mdanalysis.org/docs/documentation_pages/selections.html", ""),
