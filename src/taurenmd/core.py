...
ref_mdt = "* MD data was accessed and/or processed using [MDTraj](https://mdtraj.org/)\n."  # noqa: E501
"""Command-line docstring to reference MDTraj package."""

ref_mda = "* MD data was accessed using [MDAnalysis](https://www.mdanalysis.org).\n"  # noqa: E501
...
ref_plottemplates_param = "* plotting was performed by [python-bioplottemplates plot param function](https://python-bioplottemplates.readthedocs.io/en/latest/reference/plots.html#bioplottemplates.plots.param.plot).\n"  # noqa: E501
"""Command-line docstring to reference python-bioplottemplates param plot."""

ref_plottemplates_labeldots = "* plotting was performed by [python-bioplottemplates plot labeldots function](https://python-bioplottemplates.readthedocs.io/en/latest/reference/plots.html#bioplottemplates.plots.label_dots.plot).\n"  # noqa: E501
"""Command-line docstring to reference python-bioplottemplates labeldots plot."""  # noqa: E501

ref_pyquaternion = "* Quaterion operations were performed with [pyquaterion](http://kieranwynn.github.io/pyquaternion/).\n"  # noqa: E501
