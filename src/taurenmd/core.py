...
ref_mdt = "* MD data is accessed and/or processed using `MDTraj <https://mdtraj.org/>`_."  # noqa: E501
...
ref_numpy = '* Matrix operations were performed with `Numpy <https://www.scipy.org/citing.html>`_.'  # noqa: E501
